...
美股持仓日报关注前一交易日收盘后的组合状态，核心输出包括组合净值、现金权重、增持候选、减持候选、继续持有、重点观察、每只持仓说明和数据限制。每周复盘关注组合集中度、下周事件风险、动作复核和观察清单。评分由趋势、动量、组合集中度、新闻风险和持仓盈亏共同决定，具体参考来源和未验证边界见 `docs/methodology.md`。
